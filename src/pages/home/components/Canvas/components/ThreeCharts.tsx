...
const colorTran = [
    new THREE.Color(0, 0, 0), new THREE.Color(0.5, 0.5, 0.5),
    new THREE.Color(0.5, 0, 0), new THREE.Color(0, 0.5, 0), new THREE.Color(0, 0, 0.5),
    new THREE.Color(0.5, 0.5, 0), new THREE.Color(0.5, 0, 0.5), new THREE.Color(0, 0.5, 0.5),
    ...
    new THREE.Color(1, 0.5, 0), new THREE.Color(1, 0, 0.5), new THREE.Color(0, 1, 0.5),
    new THREE.Color(1, 0.5, 0.5), new THREE.Color(0.5, 1, 0.5), new THREE.Color(0.5, 0.5, 1),
    new THREE.Color(1, 1, 0.5), new THREE.Color(1, 0.5, 1), new THREE.Color(0.5, 1, 1),
    new THREE.Color(0.1, 0.1, 0.1), new THREE.Color(0.2, 0.1, 0.1), new THREE.Color(0.1, 0.2, 0.1),
    new THREE.Color(0.1, 0.1, 0.2), new THREE.Color(0.2, 0.2, 0.1), new THREE.Color(0.1, 0.2, 0.2),
    new THREE.Color(0.2, 0.3, 0.3), new THREE.Color(0.3, 0.2, 0.3), new THREE.Color(0.3, 0.3, 0.2),
    new THREE.Color(0.3, 0.4, 0.4), new THREE.Color(0.4, 0.3, 0.4), new THREE.Color(0.4, 0.4, 0.3),
    new THREE.Color(0.4, 0.5, 0.5), new THREE.Color(0.5, 0.4, 0.5), new THREE.Color(0.5, 0.5, 0.4),
    new THREE.Color(0.5, 0.6, 0.6), new THREE.Color(0.6, 0.5, 0.6), new THREE.Color(0.6, 0.6, 0.5),
    new THREE.Color(0.6, 0.7, 0.7), new THREE.Color(0.7, 0.6, 0.7), new THREE.Color(0.7, 0.7, 0.6),
    new THREE.Color(0.7, 0.8, 0.8), new THREE.Color(0.8, 0.7, 0.8), new THREE.Color(0.8, 0.8, 0.7),
    new THREE.Color(0.8, 0.9, 0.9), new THREE.Color(0.9, 0.8, 0.9), new THREE.Color(0.9, 0.9, 0.8),
];
...
const ThreeCharts: React.FC<Props> = (props: any) => {
    ...
    const getSize = () => {
        let maxX: any = [],
            ...
            minY: any = [],
            minZ: any = [];
        const models = getAllModelsFromScene(scene.current).filter((i: any) => i.name?.indexOf('tx') > -1);
        (models || []).forEach((mesh: any) => {
            const box = new THREE.Box3().setFromObject(mesh); // 获取模型的包围盒
            maxX.push(box.max.x);
            maxY.push(box.max.y);
                ...
                selectPathVisible ?
                    <FileManager
                        onOk={(val: any) => {
                            ...
                            const param = JSON.parse(localStorage.getItem(`localGridContentList-${params.id}`) || "[]")
                                .map((i: any) => {
                                    if (i.id === id) {
                                        return {
                                            ...i,
