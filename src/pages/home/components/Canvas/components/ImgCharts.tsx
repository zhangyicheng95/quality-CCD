    ...
    useEffect(() => {
        ...
        eventDom.onmousemove = function (event: any) {
            ...
            let bigWidth = boxWidth,
                bigHeight = boxHeight,
                scale = 1;
            if (boxWidth > bodyWidth / 2) {
                if (boxHeight > bodyHeight / 2) {
                    if (((bodyWidth / 2) / boxWidth) >= ((bodyHeight / 2) / boxHeight)) {
                        scale = (bodyWidth / 2) / boxWidth;
                        bigWidth = bodyWidth / 2;
                        bigHeight = boxHeight * scale;
                    } else {
                        scale = (bodyHeight / 2) / boxHeight;
                        bigWidth = boxWidth * scale;
                        bigHeight = bodyHeight / 2;
                    }
                } else {
                    scale = (bodyWidth / 2) / boxWidth;
                    bigWidth = bodyWidth / 2;
            ...
            } else if (boxHeight > bodyHeight / 2) {
                scale = (bodyHeight / 2) / boxHeight;
                bigWidth = boxWidth * scale;
                bigHeight = bodyHeight / 2;
            }
