...
export const createFTextClass = () => {
  ...
  fabric.FText.fromObject = function (object: any, callback: any) {
    const objectCopy = clone(object), path = object.path;
    delete objectCopy.path;
    return fabric.Object._fromObject('FText', objectCopy, function (textInstance: any) {
      textInstance.styles = fabric.util.stylesFromArray(object.styles, object.text);
      if (path) {
        fabric.Object._fromObject('Path', path, function (pathInstance: any) {
