...
import { SKETCH_ID, FABRITOR_CUSTOM_PROPS, SCHEMA_VERSION, SCHEMA_VERSION_KEY } from '@/common/constants/globalConstants';
...
import { HOVER_OBJECT_CORNER, HOVER_OBJECT_CONTROL, CAPTURE_SUBTARGET_WHEN_DBLCLICK, LOAD_JSON_IGNORE_LOAD_FONT } from '@/common/constants/globalConstants';
...
export default class Editor {
  ...
  private _initSketch() {
    ...
    const sketch = new fabric.Rect({
      ...
      fabritor_desc: "ubvision fabritor",
    });
  ...
  private _adjustSketch2Canvas() {
    ...
    this.canvas.zoomToPoint(new fabric.Point(center.left, center.top), zoomLevel - 0.01);
  ...
  private _editTextInGroup(group: any, textbox: any) {
