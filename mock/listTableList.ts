  ...
  res.json({
    ...
    data: {
            ...
            config: {
              ...
              initParams: {
                ...
                platForm_723b3e19: {
                  ...
                  localPath: 'https://seopic.699pic.com/photo/40015/5662.jpg_wh1201.jpg',
                  type: 'File',
                  description: '标注',
                  widget: {
                    type: 'ImageLabelField',
                    options: {
                      horizontal_electrode: {
                        measurement: {
                          id: 'Measurement_f6c171ac',
                          name: 'Measurement_f6c171ac',
                          alias: 'Measurement_f6c171ac',
                          orderId: 1,
                          require: false,
                          default: {
                            标准值: { alias: '标准值', value: 1 },
                            正公差: { alias: '正公差', value: 2 },
                            负公差: { alias: '负公差', value: 3 },
                            补偿值: { alias: '补偿值', value: 4 },
                          },
                          value: {
                            标准值: { alias: '标准值', value: 1 },
                            正公差: { alias: '正公差', value: 2 },
                          ...
                          type: 'float',
                          widget: { type: 'Measurement' },
                        },
                        gradient_threshold: {
                          name: 'gradient_threshold',
                          alias: 'gradient_threshold',
                          require: true,
                          default: 15,
                          value: 15,
                          type: 'int',
                ...
                platForm_7223e19: {
                  ...
                  type: 'File',
                  description: '标注',
                  widget: { type: 'ImageLabelField', id: 'platForm_723b3e19' },
                },
              },
              input: {
                src_img: {
                    ...
                    value: [
                      {
                        ...
                        props: {
                          name: '矩形矢量图形',
                          textId: 'label-text-id-1673425116332',
                          deleteMarkerId: 'label-marker-id-1673425116332',
                          label: '缺陷',
                        },
                        style: {
                          opacity: 1,
                        ...
                        shape: {
                          x: 331.7559993018706,
                          y: 157.17094700662133,
                          width: 87.26617870328407,
                          height: 45.616411594898494,
                        },
                      },
                      {
                        id: '1673425118679',
                        ...
                        props: {
                          name: '圆形矢量图层',
                          textId: 'label-text-id-1673425118679',
                          deleteMarkerId: 'label-marker-id-1673425118679',
                          label: '缺陷',
                        },
                        style: {
                          opacity: 1,
                        ...
                        option: { active: false },
                        shape: {
                          cx: 531.0798847491444,
                          cy: 130.39609672265917,
                          r: 41.5197036429828,
                        },
                      },
                    ],
      ...
      contentData: {
        ...
        content: [
          {
            id: '45e063e4-8e3e-4e10-a1cd-48be6g78e97a$$$$img',
            value: ['45e063e4-8e3e-4e10-a1cd-48be6g78e97a', null],
            size: {
              i: '45e063e4-8e3e-4e10-a1cd-48be6g78e97a$$$$img',
              x: 19,
              y: 2,
              w: 47,
              h: 20,
